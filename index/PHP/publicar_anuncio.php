<form action="vista_perfil.php?persona_id=<?=$_SESSION['userId']?>" method="post" id="publicateAd" class="modal" enctype="multipart/form-data">
    <div>
        <input type="file" name="subida_imagen_anuncio" accept="image/*" id="44" class="fileInputs">
        <label class="uploadAdLabel" for="44">
    ...
    <div id="cont_guardar">
        ...
        <button class="button" id="insertAd">Guardar</button>
    </div>
</form>