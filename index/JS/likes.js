    $(document).ready(function () {
        ...
        function like() {
            $.ajax({
                ...
                url: "../PHP/acceso_a_datos/funciones_like_JS.php?id_anuncio=" + id_anuncio + "&persona_id=" + persona_id + "&modo=dar",
                type: "GET",
                async: false
            });
        }
        ...
        function dissLike() {
            $.ajax({
                // llamar al php con un id anuncio y me devuelva el count de likes de ese anuncio
                url: "../PHP/acceso_a_datos/funciones_like_JS.php?id_anuncio=" + id_anuncio + "&persona_id=" + persona_id + "&modo=quitar",
                type: "GET",
                async: false
            });
        }
        ...
        function mostrarLikes() {
            $.ajax({
                // llamar al php con un id anuncio y me devuelva el count de likes de ese anuncio
                url: "../PHP/acceso_a_datos/funciones_like_JS.php?id_anuncio=" + id_anuncio + "&modo=anuncio",
                type: "GET",
                async: false,
        ...
        function comprobarSiHeHechoLike() {
            ...
            $.ajax({
                // llamar al php con un id anuncio y me devuelva el count de likes de ese anuncio
                url: "../PHP/acceso_a_datos/funciones_like_JS.php?id_anuncio=" + id_anuncio + "&persona_id=" + persona_id + "&modo=persona",
                type: "GET",
                async: false,
                success: function (result) {
                    variable = result;
